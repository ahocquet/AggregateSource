        ...
        public AggregateNotFoundException(string identifier, Type clrType)
            : base(
                clrType != null && identifier != null
                    ? $"The {clrType.Name} aggregate with identifier {identifier} could not be found. Please make sure the call site is indeed passing in an identifier for an {clrType.Name} aggregate."
                    : null)
        {
